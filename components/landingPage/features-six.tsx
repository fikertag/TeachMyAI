        ...
        <div className="mx-auto w-full max-w-6xl px-6">
          <div>
            <h2 className="text-foreground max-w-2xl text-balance text-4xl font-semibold">
              Build, train, and deploy your own AI assistant in minutes
            </h2>
          </div>
          <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card className="overflow-hidden p-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                Easily set up a custom AI assistant for your business, product,
                or team—no coding required.
              </p>
              <MeetingIllustration />
            </Card>
            ...
            <Card className="group overflow-hidden px-6 pt-6">
              ...
              <h3 className="text-foreground mt-5 text-lg font-semibold">
                Adding Knowledge Instantly
              </h3>
              <p className="text-muted-foreground mt-3 text-balance">
                Upload documents, connect data sources, or paste content to
                teach your AI bot everything it needs to know.
              </p>
            ...
            <Card className="group overflow-hidden px-6 pt-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                Interact with your AI via chat, integrate with your app using
                our API, or embed it directly on your website.
              </p>
  ...
  return (
    <Card aria-hidden className="mt-9 aspect-video p-4">
      <div className="relative hidden h-fit">
        <div className="absolute -left-1.5 bottom-1.5 rounded-md border-t border-blue-700 bg-blue-500 px-1 py-px text-[10px] font-medium text-white shadow-md shadow-blue-500/35">
          DOCX
        </div>
        <div className="h-10 w-8 rounded-md border bg-gradient-to-b from-blue-100 to-blue-200"></div>
      </div>
      <div className="mb-0.5 text-sm font-semibold">
        AI Bot Planning Session
      </div>
      <div className="mb-4 flex gap-2 text-sm">
        <span className="text-muted-foreground">10:00 - 11:00 AM</span>
      </div>
    ...
    >
      <div className="w-fit">
        ...
        <p className="mt-2 line-clamp-2 text-sm">
          How can I connect my data and deploy a custom AI assistant on my
          website?
        </p>
      </div>
